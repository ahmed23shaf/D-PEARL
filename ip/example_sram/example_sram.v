...
//      Test Muxes                  Off
//
//      Creation Date:  Thu Aug 31 11:22:39 2023
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module example_sram (Q, CLK, CEN, WEN, A, D, EMA, GWEN, RETN, VSSE, VDDPE, VDDCE);
`else
module example_sram (Q, CLK, CEN, WEN, A, D, EMA, GWEN, RETN);
`endif
...
`endif
  ...
  reg NOT_D10, NOT_D11, NOT_D12, NOT_D13, NOT_D14, NOT_D15, NOT_D16, NOT_D17, NOT_D18;
  reg NOT_D19, NOT_D2, NOT_D20, NOT_D21, NOT_D22, NOT_D23, NOT_D24, NOT_D25, NOT_D26;
  reg NOT_D27, NOT_D28, NOT_D29, NOT_D3, NOT_D30, NOT_D31, NOT_D4, NOT_D5, NOT_D6;
  reg NOT_D7, NOT_D8, NOT_D9, NOT_EMA0, NOT_EMA1, NOT_EMA2, NOT_GWEN, NOT_RETN, NOT_WEN0;
  reg NOT_WEN1, NOT_WEN2, NOT_WEN3;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
 ...
 wire  CLK_;
  ...
  buf B80(D_[30], D[30]);
  buf B81(D_[31], D[31]);
  buf B82(EMA_[0], EMA[0]);
  buf B83(EMA_[1], EMA[1]);
  buf B84(EMA_[2], EMA[2]);
  buf B85(GWEN_, GWEN);
  buf B86(RETN_, RETN);
