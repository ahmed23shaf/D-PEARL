...
extern "C" {
#endif
void  rmaPropagate0_p_top_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_top_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_top_tb_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1466, U  did);
void  rmaPropagate0_r_top_tb_daidir (UB  * pcode);
void  rmaPropagate0_wn_top_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_top_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_top_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_top_tb_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1466, U  did);
void  rmaPropagate1_r_top_tb_daidir (UB  * pcode);
void  rmaPropagate1_wn_top_tb_daidir (UB  * pcode, scalar  val);
